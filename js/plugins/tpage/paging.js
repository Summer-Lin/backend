...
(function(root, factory) {
    ...
    Paging.prototype = {
        init: function(settings) {
            ...
            this.container = $(this.settings.target);
        ...
        bindEvent: function() {
            ...
            this.container.on('change', 'select.ui-select-pagesize', function(e) {
                _this.pagesize=$(this).val();
                _this.settings.changeCallback && _this.settings.changeCallback(_this.current, _this.pagesize);
            });
            /*
        ...
        bindGoto: function() {
            ...
            $('input', html).click(function() {
                ...
                if (e.keyCode == 13) {
                    ...
                    _this.pagesize=$('.ui-select-pagesize').val();
                    _this.go(current);
                }
            });
